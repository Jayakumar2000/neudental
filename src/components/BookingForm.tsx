...
export default function BookingForm({ preSelectedTreatmentId, onClose, bare = false }: BookingFormProps) {
  ...
  const handleBooking = async (e: React.FormEvent) => {
    ...
    try {
      ...
      trackConversion('generate_lead', 'booking', { treatment_id: treatmentId });
