...
import { IconRootCanal, IconDentalImplant, IconBraces } from './icons/DentalIcons';
...
case 'IconRootCanal': return <IconRootCanal className="w-5 h-5" />;
case 'IconDentalImplant': return <IconDentalImplant className="w-5 h-5" />;
case 'IconBraces': return <IconBraces className="w-5 h-5" />;
