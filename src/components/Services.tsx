...
<div className="flex items-center gap-2"><IndianRupee className="w-4 h-4 text-white/60" /><div><p className="text-white/60 font-medium">Treatment Price</p><p className="font-bold text-white">{selectedTreatment.startingPrice.toLocaleString('en-IN')}</p></div></div>
</div>
