...
export const TREATMENTS: Treatment[] = [
  ...
  { id: 'dentures', name: 'Dentures', category: 'restorative', description: 'Removable or complete false teeth replacement', seoKeywords: ['dentures Chennai', 'full denture Kodungaiyur'], duration: '3-4 visits', priceRange: '₹7000-₹15000', startingPrice: 7000, iconName: 'IconDentures', features: ['Removable denture from ₹7,000', 'Complete denture from ₹15,000', 'Custom fit', 'Comfortable wear'] },
  // Cosmetic & Orthodontic Dentistry
  { id: 'cosmetic', name: 'Cosmetic Dentistry', category: 'cosmetic-ortho', description: 'Veneers & smile makeover', seoKeywords: ['dental veneers Kodungaiyur', 'smile makeover Chennai'], duration: '2-3 visits', priceRange: '₹5000+', startingPrice: 5000, iconName: 'Star', features: ['Veneers', 'Smile design', 'Natural results'] },
  { id: 'whitening', name: 'Teeth Whitening', category: 'cosmetic-ortho', description: 'Instant brighter, whiter smile', seoKeywords: ['teeth whitening Chennai', 'smile brightening Kodungaiyur'], duration: '2-3 visits', priceRange: '₹4000-₹10000', startingPrice: 4000, iconName: 'IconTeethWhitening', features: ['In-clinic whitening', 'Visible results in one sitting', 'Safe for enamel', 'Long-lasting shade'] },
  { id: 'ortho', name: 'Orthodontic Treatment', category: 'cosmetic-ortho', description: 'Braces for straighter teeth', seoKeywords: ['braces Chennai', 'orthodontic treatment Kodungaiyur'], duration: '12-24 months', priceRange: '₹30000-₹1,50,000', startingPrice: 30000, iconName: 'IconBraces', features: ['Metal & ceramic braces', 'Expert planning', 'Regular progress reviews'] },
  { id: 'invisalign', name: 'Invisalign / Clear Aligners', category: 'cosmetic-ortho', description: 'Invisible, removable tray option', seoKeywords: ['Invisalign Chennai', 'clear aligners Kodungaiyur'], duration: '6-18 months', priceRange: '₹70000-₹1,50,000', startingPrice: 70000, iconName: 'Layers', features: ['Virtually invisible', 'Removable trays', 'Custom-fit planning', 'Fewer clinic visits'] },
  // Specialized & Advanced Care
  { id: 'extraction', name: 'Wisdom Tooth Extraction', category: 'specialized', description: 'Painless impacted tooth removal', seoKeywords: ['wisdom tooth extraction Chennai', 'painless extraction Kodungaiyur'], duration: '20-30 minutes', priceRange: '₹3000+', startingPrice: 3000, iconName: 'IconWisdomToothExtraction', features: ['Local anesthesia', 'Minimal discomfort', 'Post-care instructions', 'Same day procedure'] },
  { id: 'gum-disease', name: 'Gum Disease Treatment', category: 'specialized', description: 'Treats bleeding & swollen gums', seoKeywords: ['gum disease treatment Chennai', 'periodontal therapy Kodungaiyur'], duration: '40-60 minutes', priceRange: '₹2000-₹5000', startingPrice: 2000, iconName: 'IconGumDisease', features: ['Deep cleaning', 'Antibiotic therapy', 'Gum surgery if needed', 'Regular monitoring'] },
  { id: 'implants', name: 'Dental Implants', category: 'specialized', description: 'Permanent tooth replacement', seoKeywords: ['dental implants Chennai', 'tooth implant Kodungaiyur'], duration: '3-6 months', priceRange: '₹30000-₹50000', startingPrice: 30000, iconName: 'Anchor', features: ['Titanium implants', 'Permanent solution', 'Natural feel', 'Bone preservation'] },
