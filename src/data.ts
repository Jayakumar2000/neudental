...
export const TREATMENTS: Treatment[] = [
  ...
  { id: 'cosmetic', name: 'Cosmetic Dentistry', category: 'cosmetic-ortho', description: 'Veneers & smile makeover', seoKeywords: ['dental veneers Kodungaiyur', 'smile makeover Chennai'], duration: '2-3 visits', priceRange: '₹5000+', startingPrice: 5000, iconName: 'IconCrownSmile', features: ['Veneers', 'Smile design', 'Natural results'] },
