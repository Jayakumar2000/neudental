...
export const TREATMENTS: Treatment[] = [
  ...
  { id: 'checkup', name: 'Regular Check-up', category: 'preventive', description: 'Dental checkup & oral exam', seoKeywords: ['dental checkup Kodungaiyur', 'dental exam Chennai'], duration: '30-45 minutes', priceRange: '₹300-₹500', startingPrice: 300, iconName: 'Search', features: ['Oral examination', 'X-ray review', 'Treatment planning', 'Oral hygiene advice'] },
  { id: 'cleaning', name: 'Dental Cleaning', category: 'preventive', description: 'Teeth cleaning & scaling', seoKeywords: ['teeth cleaning Chennai', 'dental scaling Kodungaiyur'], duration: '45-60 minutes', priceRange: '₹800-₹1500', startingPrice: 800, iconName: 'Sparkles', features: ['Ultrasonic scaling', 'Polishing', 'Fluoride treatment', 'Oral hygiene instructions'] },
  { id: 'imaging', name: 'Dental Imaging', category: 'preventive', description: 'Digital X-rays & imaging', seoKeywords: ['dental X-ray Chennai', 'digital radiography'], duration: '15-30 minutes', priceRange: '₹200-₹800', startingPrice: 200, iconName: 'Scan', features: ['Digital X-rays', 'Low radiation', 'Instant results', 'High-resolution images'] },
  // Restorative Dentistry
  { id: 'filling', name: 'Cavity Filling', category: 'restorative', description: 'Tooth-colored cavity fillings', seoKeywords: ['tooth filling Chennai', 'composite filling Kodungaiyur'], duration: '30-60 minutes', priceRange: '₹500-₹2000', startingPrice: 500, iconName: 'Shield', features: ['Tooth-colored material', 'Mercury-free', 'Single sitting', 'Natural appearance'] },
  { id: 'extraction', name: 'Wisdom Tooth Extraction', category: 'restorative', description: 'Painless wisdom tooth extraction', seoKeywords: ['wisdom tooth extraction Chennai', 'painless extraction Kodungaiyur'], duration: '20-45 minutes', priceRange: '₹300-₹1500', startingPrice: 300, iconName: 'Scissors', features: ['Local anesthesia', 'Minimal discomfort', 'Post-care instructions', 'Same day procedure'] },
  { id: 'crowns-bridges', name: 'Crowns & Bridges', category: 'restorative', description: 'Dental crowns & bridges', seoKeywords: ['dental crown Chennai', 'tooth bridge Kodungaiyur'], duration: '2-3 visits', priceRange: '₹4000-₹12000', startingPrice: 4000, iconName: 'Crown', features: ['Ceramic crowns', 'Metal-free options', 'Natural appearance', 'Long lasting'] },
  { id: 'dentures', name: 'Dentures', category: 'restorative', description: 'Full & partial dentures', seoKeywords: ['dentures Chennai', 'full denture Kodungaiyur'], duration: '3-5 visits', priceRange: '₹8000-₹30000', startingPrice: 8000, iconName: 'Smile', features: ['Custom fit', 'Natural appearance', 'Easy maintenance', 'Comfortable wear'] },
  ...
  { id: 'whitening', name: 'Teeth Whitening', category: 'cosmetic-ortho', description: 'Professional teeth whitening', seoKeywords: ['teeth whitening Chennai', 'smile brightening Kodungaiyur'], duration: '45-60 minutes', priceRange: '₹4000-₹10000', startingPrice: 4000, iconName: 'Sun', features: ['In-clinic whitening', 'Visible results in one sitting', 'Safe for enamel', 'Long-lasting shade'] },
