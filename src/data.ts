...
export const TREATMENTS: Treatment[] = [
  ...
  { id: 'whitening', name: 'Teeth Whitening', category: 'cosmetic-ortho', description: 'Instant brighter, whiter smile', seoKeywords: ['teeth whitening Chennai', 'smile brightening Kodungaiyur'], duration: '2-3 visits', priceRange: '₹4000-₹10000', startingPrice: 4000, iconName: 'Sun', features: ['In-clinic whitening', 'Visible results in one sitting', 'Safe for enamel', 'Long-lasting shade'] },
