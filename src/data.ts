...
export const TREATMENTS: Treatment[] = [
  ...
  { id: 'imaging', name: 'Dental Imaging', category: 'preventive', description: 'Digital X-ray & OPG scans', seoKeywords: ['dental X-ray Chennai', 'digital radiography'], duration: '10-15 minutes', priceRange: '₹200-₹800', startingPrice: 200, iconName: 'IconDentalImaging', features: ['Digital X-rays', 'Low radiation', 'Cavity & infection detection', 'Root & bone assessment', 'Precision treatment planning'] },
  ...
  { id: 'cosmetic', name: 'Cosmetic Dentistry', category: 'cosmetic-ortho', description: 'Veneers & smile makeover', seoKeywords: ['dental veneers Kodungaiyur', 'smile makeover Chennai'], duration: '2-3 visits', priceRange: '₹5000+', startingPrice: 5000, iconName: 'IconCrownSmile', features: ['Veneers', 'Smile design', 'Smile assessment', 'Tooth shape & colour enhancement'] },
  { id: 'whitening', name: 'Teeth Whitening', category: 'cosmetic-ortho', description: 'Instant brighter, whiter smile', seoKeywords: ['teeth whitening Chennai', 'smile brightening Kodungaiyur'], duration: '2-3 visits', priceRange: '₹4000-₹10000', startingPrice: 4000, iconName: 'IconTeethWhitening', features: ['In-clinic whitening', 'Visible results in one sitting', 'Gentle, enamel-safe treatment', 'Surface stain removal', 'Personalised shade assessment'] },
  { id: 'ortho', name: 'Orthodontic Treatment', category: 'cosmetic-ortho', description: 'Braces for straighter teeth', seoKeywords: ['braces Chennai', 'orthodontic treatment Kodungaiyur'], duration: '12-24 months', priceRange: '₹30000-₹1,50,000', startingPrice: 30000, iconName: 'IconBraces', features: ['Metal & ceramic braces', 'Regular progress reviews', 'Teeth alignment correction', 'Bite correction', 'Crowding & spacing correction'] },
