...
export const TREATMENTS: Treatment[] = [
  ...
  { id: 'extraction', name: 'Wisdom Tooth Extraction', category: 'restorative', description: 'Safe and painless wisdom tooth removal with modern anesthesia for minimal discomfort.', seoKeywords: ['wisdom tooth extraction Chennai', 'painless extraction Kodungaiyur'], duration: '20-45 minutes', priceRange: '₹300-₹1500', startingPrice: 300, iconName: 'Scissors', features: ['Local anesthesia', 'Minimal discomfort', 'Post-care instructions', 'Same day procedure'] },
  ...
  { id: 'cosmetic', name: 'Cosmetic Dentistry', category: 'cosmetic-ortho', description: 'Teeth whitening, veneers, and complete smile makeovers for a confident smile.', seoKeywords: ['dental veneers Kodungaiyur', 'smile makeover Chennai'], duration: 'Varies', priceRange: '₹5000+', startingPrice: 5000, iconName: 'Star', features: ['Veneers', 'Smile design', 'Natural results'] },
  { id: 'whitening', name: 'Teeth Whitening', category: 'cosmetic-ortho', description: 'Professional in-clinic teeth whitening to remove stains and brighten your smile safely.', seoKeywords: ['teeth whitening Chennai', 'smile brightening Kodungaiyur'], duration: '45-60 minutes', priceRange: '₹4000-₹10000', startingPrice: 4000, iconName: 'Sun', features: ['In-clinic whitening', 'Visible results in one sitting', 'Safe for enamel', 'Long-lasting shade'] },
  { id: 'ortho', name: 'Orthodontic Treatment', category: 'cosmetic-ortho', description: 'Modern braces to straighten teeth and improve your smile.', seoKeywords: ['braces Chennai', 'orthodontic treatment Kodungaiyur'], duration: '12-24 months', priceRange: '₹35000-₹1,50,000', startingPrice: 35000, iconName: 'GitBranch', features: ['Metal & ceramic braces', 'Expert planning', 'Regular progress reviews'] },
  { id: 'invisalign', name: 'Invisalign / Clear Aligners', category: 'cosmetic-ortho', description: 'Custom, virtually invisible clear aligners to straighten teeth discreetly without metal braces.', seoKeywords: ['Invisalign Chennai', 'clear aligners Kodungaiyur'], duration: '6-18 months', priceRange: '₹40000-₹1,50,000', startingPrice: 40000, iconName: 'Layers', features: ['Virtually invisible', 'Removable trays', 'Custom-fit planning', 'Fewer clinic visits'] },
  ...
  { id: 'laser-dentistry', name: 'Laser Dentistry', category: 'specialized', description: 'Advanced laser-assisted procedures for gum treatment, cavity care and soft-tissue work with less pain and faster healing.', seoKeywords: ['laser dentistry Chennai', 'painless laser treatment Kodungaiyur'], duration: '30-60 minutes', priceRange: '₹2000-₹8000', startingPrice: 2000, iconName: 'Zap', features: ['Minimal discomfort', 'Reduced bleeding', 'Faster healing', 'Precision treatment'] },
  // Kids / Pediatric Dentistry
  { id: 'kids-dentistry', name: 'Kids Dentistry', category: 'pediatric', description: 'Gentle, child-friendly dental care from a first checkup through cavity treatment, in a calm and reassuring environment.', seoKeywords: ['pediatric dentist Chennai', 'kids dentist Kodungaiyur'], duration: '20-40 minutes', priceRange: '₹300-₹2000', startingPrice: 300, iconName: 'Baby', features: ['Child-friendly approach', 'Preventive & restorative care', 'Cavity treatment', 'Dental habit guidance'] },
];
