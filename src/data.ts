...
export const TREATMENTS: Treatment[] = [
  ...
  { id: 'ortho', name: 'Orthodontic Treatment', category: 'cosmetic-ortho', description: 'Braces for straighter teeth', seoKeywords: ['braces Chennai', 'orthodontic treatment Kodungaiyur'], duration: '12-24 months', priceRange: '₹35000-₹1,50,000', startingPrice: 35000, iconName: 'IconBraces', features: ['Metal & ceramic braces', 'Expert planning', 'Regular progress reviews'] },
  ...
  { id: 'implants', name: 'Dental Implants', category: 'specialized', description: 'Permanent tooth replacement', seoKeywords: ['dental implants Chennai', 'tooth implant Kodungaiyur'], duration: '3-6 months total', priceRange: '₹25000-₹50000', startingPrice: 25000, iconName: 'IconDentalImplant', features: ['Titanium implants', 'Permanent solution', 'Natural feel', 'Bone preservation'] },
