...
export const TREATMENTS: Treatment[] = [
  ...
  { id: 'checkup', name: 'Regular Check-up', category: 'preventive', description: 'Early cavity & gum diagnosis', seoKeywords: ['dental checkup Kodungaiyur', 'dental exam Chennai'], duration: '30-45 minutes', priceRange: '₹300-₹500', startingPrice: 300, iconName: 'IconRegularCheckup', features: ['Oral examination', 'Early detection of dental problems', 'Complimentary X-ray', 'Treatment planning', 'Oral hygiene advice'] },
  { id: 'cleaning', name: 'Dental Cleaning', category: 'preventive', description: 'Removes plaque & tartar buildup', seoKeywords: ['teeth cleaning Chennai', 'dental scaling Kodungaiyur'], duration: '30-45 minutes', priceRange: '₹1000-₹1500', startingPrice: 1000, iconName: 'IconDentalCleaning', features: ['Ultrasonic scaling & polishing', 'Plaque & tartar removal', 'Gum health maintenance', 'Fluoride treatment', 'Oral hygiene instructions'] },
  { id: 'imaging', name: 'Dental Imaging', category: 'preventive', description: 'Digital X-ray & OPG scans', seoKeywords: ['dental X-ray Chennai', 'digital radiography'], duration: '10-15 minutes', priceRange: '₹200-₹800', startingPrice: 200, iconName: 'IconDentalImaging', features: ['Digital X-rays', 'Cavity & infection detection', 'Root & bone assessment', 'Precision treatment planning', 'Instant results'] },
  // Restorative Dentistry
  { id: 'filling', name: 'Cavity Filling', category: 'restorative', description: 'Tooth-colored composite restoration', seoKeywords: ['tooth filling Chennai', 'composite filling Kodungaiyur'], duration: '20-30 minutes', priceRange: '₹1000-₹2000', startingPrice: 1000, iconName: 'IconCavityFilling', features: ['Early cavity detection', 'Decay removal', 'Tooth-colored material', 'Mercury-free', 'Single sitting', 'Natural appearance'] },
  { id: 'rct', name: 'Root Canal Treatment (RCT)', category: 'restorative', description: 'Saves infected tooth, pain-free', seoKeywords: ['root canal treatment Chennai', 'RCT Kodungaiyur', 'single sitting RCT Chennai'], duration: '40-60 minutes', priceRange: '₹3500-₹8000', startingPrice: 3500, iconName: 'IconRootCanal', features: ['Pulp & infection assessment', 'Rotary endodontics', 'Canal disinfection & sealing', 'Single sitting possible', 'Crown placement', 'Pain-free procedure'] },
  { id: 'crowns-bridges', name: 'Crowns & Bridges', category: 'restorative', description: 'Restores broken or missing teeth', seoKeywords: ['dental crown Chennai', 'tooth bridge Kodungaiyur'], duration: '2-3 visits', priceRange: '₹4000-₹12000', startingPrice: 4000, iconName: 'IconCrownsAndBridges', features: ['Custom ceramic crowns', 'Fixed dental bridges', 'Metal-free options', 'Damaged tooth protection', 'Natural appearance', 'Long lasting'] },
  { id: 'dentures', name: 'Dentures', category: 'restorative', description: 'Removable or complete false teeth replacement', seoKeywords: ['dentures Chennai', 'full denture Kodungaiyur'], duration: '3-4 visits', priceRange: '₹7000-₹15000', startingPrice: 7000, iconName: 'IconDentures', features: ['Removable denture from ₹7,000', 'Complete denture from ₹15,000', 'Custom fit', 'Improved chewing & function', 'Natural-looking smile restoration'] },
  // Cosmetic & Orthodontic Dentistry
  { id: 'cosmetic', name: 'Cosmetic Dentistry', category: 'cosmetic-ortho', description: 'Veneers & smile makeover', seoKeywords: ['dental veneers Kodungaiyur', 'smile makeover Chennai'], duration: '2-3 visits', priceRange: '₹5000+', startingPrice: 5000, iconName: 'IconCrownSmile', features: ['Smile assessment', 'Veneers & smile design', 'Tooth shape & colour enhancement', 'Natural results', 'Personalised smile makeover'] },
  { id: 'whitening', name: 'Teeth Whitening', category: 'cosmetic-ortho', description: 'Instant brighter, whiter smile', seoKeywords: ['teeth whitening Chennai', 'smile brightening Kodungaiyur'], duration: '2-3 visits', priceRange: '₹4000-₹10000', startingPrice: 4000, iconName: 'IconTeethWhitening', features: ['Personalised shade assessment', 'In-clinic whitening', 'Surface stain removal', 'Visible results in one sitting', 'Safe for enamel', 'Long-lasting shade'] },
  { id: 'ortho', name: 'Orthodontic Treatment', category: 'cosmetic-ortho', description: 'Braces for straighter teeth', seoKeywords: ['braces Chennai', 'orthodontic treatment Kodungaiyur'], duration: '12-24 months', priceRange: '₹30000-₹1,50,000', startingPrice: 30000, iconName: 'IconBraces', features: ['Comprehensive orthodontic assessment', 'Metal & ceramic braces', 'Teeth alignment & bite correction', 'Crowding & spacing correction', 'Regular progress reviews'] },
  { id: 'invisalign', name: 'Invisalign / Clear Aligners', category: 'cosmetic-ortho', description: 'Invisible, removable tray option', seoKeywords: ['Invisalign Chennai', 'clear aligners Kodungaiyur'], duration: '6-18 months', priceRange: '₹70000-₹1,50,000', startingPrice: 70000, iconName: 'IconDentalSurgery', features: ['Digital smile planning', 'Virtually invisible', 'Removable trays', 'Custom-fit planning', 'Fewer clinic visits'] },
  // Specialized & Advanced Care
  { id: 'extraction', name: 'Wisdom Tooth Extraction', category: 'specialized', description: 'Painless impacted tooth removal', seoKeywords: ['wisdom tooth extraction Chennai', 'painless extraction Kodungaiyur'], duration: '20-30 minutes', priceRange: '₹3000+', startingPrice: 3000, iconName: 'IconWisdomToothExtraction', features: ['Wisdom tooth assessment', 'Impacted tooth evaluation', 'Local anesthesia', 'Minimal discomfort', 'Same day procedure', 'Post-care instructions'] },
  { id: 'gum-disease', name: 'Gum Disease Treatment', category: 'specialized', description: 'Treats bleeding & swollen gums', seoKeywords: ['gum disease treatment Chennai', 'periodontal therapy Kodungaiyur'], duration: '40-60 minutes', priceRange: '₹2000-₹5000', startingPrice: 2000, iconName: 'IconGumDisease', features: ['Comprehensive gum assessment', 'Deep cleaning', 'Antibiotic therapy', 'Gum surgery if needed', 'Regular monitoring'] },
  { id: 'implants', name: 'Dental Implants', category: 'specialized', description: 'Permanent tooth replacement', seoKeywords: ['dental implants Chennai', 'tooth implant Kodungaiyur'], duration: '3-6 months', priceRange: '₹30000-₹50000', startingPrice: 30000, iconName: 'IconToothDrill', features: ['Dental implant assessment', 'Digital implant planning', 'Titanium implants', 'Permanent solution', 'Natural feel', 'Bone preservation'] },
  { id: 'laser-dentistry', name: 'Laser Dentistry', category: 'specialized', description: 'Bloodless, suture-free procedures', seoKeywords: ['laser dentistry Chennai', 'painless laser treatment Kodungaiyur'], duration: '30-60 minutes', priceRange: '₹2000-₹8000', startingPrice: 2000, iconName: 'IconTools', features: ['Precision soft-tissue treatment', 'Laser gum procedures', 'Minimal discomfort', 'Reduced bleeding', 'Faster healing'] },
  // Kids / Pediatric Dentistry
  { id: 'kids-dentistry', name: 'Kids Dentistry', category: 'pediatric', description: 'Gentle, fear-free visits for children', seoKeywords: ['pediatric dentist Chennai', 'kids dentist Kodungaiyur'], duration: '20-40 minutes', priceRange: '₹1000-₹2000', startingPrice: 1000, iconName: 'IconDentalCare', features: ['Child-friendly approach', 'Cavity treatment & prevention', 'Tooth & jaw development monitoring', 'Preventive & restorative care', 'Dental habit guidance'] },
];
